    ...
    <section className="w-full pt-16 px-8 pb-80" style={{ backgroundColor: '#DDDDDD', position: 'relative', zIndex: 10 }}>
      <div className="max-w-5xl mx-auto flex flex-col gap-8 relative">
        <div>
          ...
          <p className="font-mono text-lg text-gray-700 mb-8 max-w-2xl">
          ...
          <div className="flex gap-4">
            ...
            <button
              className="rounded px-5 py-2 font-mono font-semibold text-base border border-gray-900 transition-colors"
