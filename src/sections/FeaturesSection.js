...
function FeaturesSection() {
  ...
  function getCardProgress(i) {
    const cardStart = i * collapseStep;
    return Math.min(1, Math.max(0, (scrollRef.current - cardStart) / collapseStep));
  }
  ...
  return (
    <>
      <section className="md:h-[150px] h-[70px] bg-[#DDDDDD]" id="features"></section>
                    ...
                    f.isFinal ? (
                      <div className="bg-[#D2F944] flex flex-col items-center justify-center w-full p-4 text-center mb-6">
                        ...
                        <div className="flex-shrink-0 w-full">
                          <p className="text-md text-left text-[#252525] mt-5 mb-5 md:max-w-xs w-full mx-auto">{f.heading}</p>
                        ...
                        <div className="absolute inset-0 p-5 flex flex-col justify-between h-full">
                          <div className="flex justify-between items-start gap-4">
                            <div className="max-w-xs">
                              ...
                              <h2 className="mobile-heading md:text-2xl text-[22px] font-mono mb-0 text-[#252525] tracking-normal" style={{ transition: "opacity 0.2s linear" }}>
                                {f.heading}
                              </h2>
                            </div>
                            {f.svg && (
